...
export PYTORCH_TUNABLEOP_FILENAME=tuned/7b/full_tuned%d.csv
export PYTORCH_TUNABLEOP_TUNING=0
export PYTORCH_TUNABLEOP_ENABLED=1

EXPERIMENT_DIR="/workspace/pretrain/qwen_7B"
...
TRAIN_LOG="${EXPERIMENT_DIR}/logs/log_7B_${TP}_${PP}_${DP}_${MBS}_${GBS}_${SEQ_LENGTH}.txt"
