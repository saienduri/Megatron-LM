...
# bash train_llama2_13b.sh MODEL_SIZE=70 MBS=4 TP=8 PP=1 BS=6 SEQ_LENGTH=4096 SEQ_PARALLEL=1 USE_FLASH_ATTN=1 TE_FP16=0 NO_TORCH_COMPILE=0 TOTAL_ITERS=4 TEE_OUTPUT=1 OPTIMIZER=sgd
