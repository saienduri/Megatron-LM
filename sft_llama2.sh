...
EPOCHS="${EPOCHS:-1}"
_TOTAL_ITERS=`python -c "import math; print(int(math.floor(51760/$BS*$EPOCHS)))"`
TOTAL_ITERS="${TOTAL_ITERS:-2000}"
...
TOKENIZER_MODEL=../checkpoint/llama2-7b-hf
CHECKPOINT_PATH=../checkpoint/llama2-7b-mgm
