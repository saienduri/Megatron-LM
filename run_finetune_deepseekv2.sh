...
MODEL_SIZE="${MODEL_SIZE:-16B}"
MBS="${MBS:-2}"
GBS="${GBS:-8}"
LR="${LR:-1e-5}"
MIN_LR="${LR:-1e-6}"
SEQ_LEN="${SEQ_LENGTH:-2048}"
PAD_LEN="${PAD_LEN:-2048}"
PR="${LR:-fp16}"
TP="${TP:-8}"
PP="${PP:-1}"
EP="${EP:-1}" #Expert model paralel size
AC="${AC:-sel}" #Activation cp
DO="${DO:-true}" #Distributed optimizer
FL="${FL:-true}" #use flash attention
SP="${SP:-true}" #sequence parallel
SAVE_INTERVAL=${SAVE_INTERVAL:-None}
