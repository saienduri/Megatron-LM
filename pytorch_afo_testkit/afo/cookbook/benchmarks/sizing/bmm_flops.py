...
if __name__ == "__main__":
    ...
    b_group.add_argument(
        ...
        nargs="+",
        type=int,
        help="The batched dimension of the BMM, enter any number of arguments",
    )
    b_group.add_argument(
        "--b_range",
        nargs="+",
        type=int,
        help="The batched dimension of the BMM, [start,stop,step]",
    )
    ...
    m_group.add_argument(
        ...
        nargs="+",
        type=int,
        help="The first dimension of the BMM, enter any number of arguments",
    )
    m_group.add_argument(
        "--m_range",
        nargs="+",
        type=int,
        help="The first dimension of the BMM, [start,stop,step]",
    )
    ...
    n_group.add_argument(
        ...
        nargs="*",
        type=int,
        help="The shared dimension of the BMM, enter any number of arguments",
    )
    n_group.add_argument(
        "--n_range",
        nargs="+",
        type=int,
        help="The shared dimension of the BMM, [start,stop,step]",
    )
    ...
    k_group.add_argument(
        ...
        nargs="*",
        type=int,
        help="The last dimension of the BMM, enter any number of arguments",
    )
    k_group.add_argument(
        "--k_range",
        nargs="+",
        type=int,
        help="The last dimension of the BMM, [start,stop,step]",
    )
    ...
    parser.add_argument(
        "--output_file", type=str, default=f"{file_dir}/results/bmm.out"
    )
    parser.add_argument(
        "--verbose",
        default=True,
