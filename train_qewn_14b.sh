...
export PYTORCH_TUNABLEOP_FILENAME=tuned/14b/full_tuned%d.csv
export PYTORCH_TUNABLEOP_TUNING=0
export PYTORCH_TUNABLEOP_ENABLED=1

EXPERIMENT_DIR="/workspace/pretrain/qwen_14B"
...
TRAIN_LOG="${EXPERIMENT_DIR}/logs/log_14B_${TP}_${PP}_${DP}_${MBS}_${GBS}_${SEQ_LENGTH}.txt"
